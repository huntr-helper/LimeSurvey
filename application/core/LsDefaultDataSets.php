...
class LsDefaultDataSets
{
    ...
    public static function getTemplateConfigurationData()
    {
        ...
        $returnArray[] = [
            ...
            'gsid'              =>  null,
            'uid'               =>  null,
            'files_css'         => '{"add":["css/variations/theme_apple.css","css/base.css","css/noTablesOnMobile.css","css/custom.css"],
                                     "remove":["survey.css", "template-core.css", "awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css", "awesome-bootstrap-checkbox/awesome-bootstrap-checkbox-rtl.css"]}',
            'files_js'          =>  '{"add":["scripts/theme.js","scripts/custom.js"], "remove":["survey.js", "template-core.js"]}',
            'files_print_css'   => '{"add":["css/print_theme.css"]}',
            'options'           => '{"container":"off","zebrastriping":"off","stickymatrixheaders":"off",
                                     "greyoutselected":"off","hideprivacyinfo":"off","crosshover":"off","showpopups":"1",
                                     "notables":"1","showclearall":"off","questionhelptextposition":"top","fixnumauto":"disable",
                                     "darkmode":"off","backgroundimage":"off","backgroundimagefile":".\/files\/pattern.png",
